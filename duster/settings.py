...
SECRET_KEY = 'f_93x5e2205g*mfl4*b*&=x17ii#4y-)md@k!#_y6g65bh8af-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
ALLOWED_HOSTS = ['duster.com']
...
WSGI_APPLICATION = 'duster.wsgi.application'
